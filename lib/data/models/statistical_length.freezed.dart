...
extension StatisticalLengthPatterns on StatisticalLength {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_StatisticalLength value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int vocabLearnedCount, int countVocabulaireAll)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _StatisticalLength() when $default != null:
        return $default(_that.vocabLearnedCount, _that.countVocabulaireAll);
      case _:
        return orElse();
    }
  }
  ...
  TResult when<TResult extends Object?>(
    TResult Function(int vocabLearnedCount, int countVocabulaireAll) $default,
  ) {
    final _that = this;
    switch (_that) {
      case _StatisticalLength():
