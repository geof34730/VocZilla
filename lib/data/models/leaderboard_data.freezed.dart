...
// Les propriétés ne changent pas
  ...
  $LeaderboardDataCopyWith<LeaderboardData> get copyWith =>
      _$LeaderboardDataCopyWithImpl<LeaderboardData>(
          this as LeaderboardData, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other.topUsers, topUsers) &&
            (identical(other.currentUserRank, currentUserRank) ||
                other.currentUserRank == currentUserRank) &&
            (identical(other.totalWordsInLevel, totalWordsInLevel) ||
                other.totalWordsInLevel == totalWordsInLevel));
  }
  ...
  int get hashCode => Object.hash(
      runtimeType,
      const DeepCollectionEquality().hash(topUsers),
      currentUserRank,
      totalWordsInLevel);
...
abstract mixin class $LeaderboardDataCopyWith<$Res> {
  factory $LeaderboardDataCopyWith(
          LeaderboardData value, $Res Function(LeaderboardData) _then) =
      _$LeaderboardDataCopyWithImpl;
  @useResult
  $Res call(
      {List<LeaderboardUser> topUsers,
      int currentUserRank,
      int totalWordsInLevel});
}
...
class _$LeaderboardDataCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? currentUserRank = null,
    Object? totalWordsInLevel = null,
  }) {
    return _then(_self.copyWith(
      ...
      currentUserRank: null == currentUserRank
          ...
          : currentUserRank // ignore: cast_nullable_to_non_nullable
              as int,
      totalWordsInLevel: null == totalWordsInLevel
          ? _self.totalWordsInLevel
          : totalWordsInLevel // ignore: cast_nullable_to_non_nullable
              as int,
    ));
  }
}
...
extension LeaderboardDataPatterns on LeaderboardData {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_LeaderboardData value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<LeaderboardUser> topUsers, int currentUserRank,
            int totalWordsInLevel)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _LeaderboardData() when $default != null:
        return $default(
            _that.topUsers, _that.currentUserRank, _that.totalWordsInLevel);
      case _:
        return orElse();
    }
  }
...
class _LeaderboardData implements LeaderboardData {
  const _LeaderboardData(
      {required final List<LeaderboardUser> topUsers,
...
// Les propriétés ne changent pas
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$LeaderboardDataCopyWith<_LeaderboardData> get copyWith =>
      __$LeaderboardDataCopyWithImpl<_LeaderboardData>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$LeaderboardDataToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$LeaderboardDataCopyWith<$Res>
    implements $LeaderboardDataCopyWith<$Res> {
  factory _$LeaderboardDataCopyWith(
          _LeaderboardData value, $Res Function(_LeaderboardData) _then) =
      __$LeaderboardDataCopyWithImpl;
  @override
  @useResult
  $Res call(
      {List<LeaderboardUser> topUsers,
