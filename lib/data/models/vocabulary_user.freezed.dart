...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(listPerso),const DeepCollectionEquality().hash(listTheme),const DeepCollectionEquality().hash(listGuidVocabularyLearned),countVocabulaireAll);
...
@useResult
$Res call({
@JsonKey(name: "ListPerso") List<ListPerso> listPerso,@JsonKey(name: "ListTheme") List<ListTheme> listTheme,@JsonKey(name: "ListGuidVocabularyLearned") List<String> listGuidVocabularyLearned,@JsonKey(name: "CountVocabulaireAll", defaultValue: 0) int countVocabulaireAll
});
...
/// Create a copy of VocabulaireUser
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? listPerso = null,Object? listTheme = null,Object? listGuidVocabularyLearned = null,Object? countVocabulaireAll = null,}) {
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_listPerso),const DeepCollectionEquality().hash(_listTheme),const DeepCollectionEquality().hash(_listGuidVocabularyLearned),countVocabulaireAll);
...
/// Create a copy of VocabulaireUser
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? listPerso = null,Object? listTheme = null,Object? listGuidVocabularyLearned = null,Object? countVocabulaireAll = null,}) {
