...
mixin _$LeaderboardUser {
  ...
  $LeaderboardUserCopyWith<LeaderboardUser> get copyWith =>
      _$LeaderboardUserCopyWithImpl<LeaderboardUser>(
          this as LeaderboardUser, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is LeaderboardUser &&
            (identical(other.pseudo, pseudo) || other.pseudo == pseudo) &&
            (identical(other.createdAt, createdAt) ||
                other.createdAt == createdAt) &&
            (identical(other.listPersoCount, listPersoCount) ||
                other.listPersoCount == listPersoCount) &&
...
abstract mixin class $LeaderboardUserCopyWith<$Res> {
  factory $LeaderboardUserCopyWith(
          LeaderboardUser value, $Res Function(LeaderboardUser) _then) =
      _$LeaderboardUserCopyWithImpl;
  @useResult
  $Res call(
      {String pseudo,
      DateTime createdAt,
    ...
    return _then(_self.copyWith(
      ...
      createdAt: null == createdAt
          ...
          : createdAt // ignore: cast_nullable_to_non_nullable
              as DateTime,
      listPersoCount: null == listPersoCount
          ? _self.listPersoCount
          : listPersoCount // ignore: cast_nullable_to_non_nullable
              as int,
...
extension LeaderboardUserPatterns on LeaderboardUser {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_LeaderboardUser value)? $default, {
...
class _LeaderboardUser implements LeaderboardUser {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$LeaderboardUserCopyWith<_LeaderboardUser> get copyWith =>
      __$LeaderboardUserCopyWithImpl<_LeaderboardUser>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$LeaderboardUserToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$LeaderboardUserCopyWith<$Res>
    implements $LeaderboardUserCopyWith<$Res> {
  factory _$LeaderboardUserCopyWith(
          _LeaderboardUser value, $Res Function(_LeaderboardUser) _then) =
      __$LeaderboardUserCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String pseudo,
